...
export default function CollegeAdminTeachersPage() {
  ...
  const toggleStatus = async (teacher: Teacher) => {
    try {
      ...
      setError("");
      await fetchJson(
        `${API_BASE}/api/accounts/college-admin/teachers/${teacher.id}/`,
        {
          method: "PATCH",
          headers: {
          ...
          <div className="container-fluid">
            <div className="d-flex justify-content-between align-items-start gap-3 flex-wrap mb-4">
              ...
              <Link
                ...
                href="/college-admin/teachers/create"
              >
                Add Teacher
              </Link>
            </div>
            ...
            {loading ? (
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body py-5 text-center">
                  <h5 className="fw-bold">No Teachers</h5>
                  <p className="text-muted mb-0">
                    Teachers created for this college will appear here.
                  </p>
                </div>
              </div>
            ) : (
