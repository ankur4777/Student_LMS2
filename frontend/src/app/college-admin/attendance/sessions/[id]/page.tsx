...
export default function CollegeAdminAttendanceSessionPage() {
    ...
    const loadSession = async () => {
      ...
      try {
        const response = await fetch(
          `${API_BASE}/api/attendance/college-admin/sessions/${params.id}/`,
          {
            headers: {
        ...
        if (!response.ok) {
          throw new Error(
            result.detail || "Unable to load attendance session."
          );
        }
          ...
          <div className="container-fluid">
            <div className="d-flex justify-content-between align-items-center mb-4">
              <div>
                ...
                <p className="text-muted mb-0">
                  Read-only attendance records for this session.
                </p>
              </div>
            ...
            {loading && (
              <div className="card border-0 shadow-sm">
                <div className="card-body p-4">Loading session...</div>
              </div>
            )}
