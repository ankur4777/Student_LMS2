...
export default function EditSectionPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        const [sectionResponse, sessionsResponse, classesResponse] =
          await Promise.all([
            fetch(
              `${API_BASE}/api/academics/college-admin/sections/${params.id}/`,
              {
                headers: {
        ...
        if (!sectionResponse.ok) {
          throw new Error(sectionResult?.detail || "Unable to load section.");
        }
        ...
        const current = sectionResult.section as Section;
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        setError(result?.detail || "Unable to update section.");
        return;
      }

      router.replace("/college-admin/sections");
    } catch {
      ...
      <main className="teacher-dashboard-main">
        ...
        <div className="teacher-dashboard-content">
          <div className="container-fluid">
            <div className="mb-4">
              <h2 className="fw-bold mb-1">Edit Section</h2>
              <p className="text-muted mb-0">
                Update section name and class.
              </p>
            </div>
                    ...
                    <div className="row g-3">
                      ...
                      <div className="col-12 d-flex gap-2">
                        ...
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            router.push("/college-admin/sections")
                          }
                        >
                          Cancel
                        </button>
