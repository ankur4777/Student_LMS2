...
export default function EditSubjectPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        const [subjectResponse, sessionsResponse, classesResponse] =
          await Promise.all([
            fetch(
              `${API_BASE}/api/academics/college-admin/subjects/${params.id}/`,
              {
                headers: {
        ...
        if (!subjectResponse.ok) {
          throw new Error(subjectResult?.detail || "Unable to load subject.");
        }
        ...
        const current = subjectResult.subject as Subject;
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        setError(result?.detail || "Unable to update subject.");
        return;
      }
      ...
      <main className="teacher-dashboard-main">
        ...
        <div className="teacher-dashboard-content">
          <div className="container-fluid">
            <div className="mb-4">
              <h2 className="fw-bold mb-1">Edit Subject</h2>
              <p className="text-muted mb-0">
                Update subject details and class.
              </p>
            </div>
